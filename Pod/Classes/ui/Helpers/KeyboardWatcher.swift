...
final class KeyboardWatcher {
  ...
  func startWatching(onKeyboardShown: OnKeyboardShown? = nil, onKeyboardHide: OnKeyboardHide? = nil) {
    ...
    notificationCenter.addObserver(self, selector: #selector(onKeyboardWillShow(_:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    notificationCenter.addObserver(self, selector: #selector(onKeyboardWillHide(_:)), name: UIResponder.keyboardWillHideNotification, object: nil)
  }
  ...
  @objc private func onKeyboardWillShow(_ notification: Notification) {
    ...
    self.onKeyboardShown?(keyboardSize)
  }
