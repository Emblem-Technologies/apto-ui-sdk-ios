//
//  ManageCardTopMessageView.swift
//  AptoSDK
//
...
class ManageCardTopMessageView: UIView {
  private let config: ManageCardTopMessageViewConfig
  private let uiConfig: UIConfig
  private let titleLabel: UILabel
  private let messageLabel: UILabel

  init(config: ManageCardTopMessageViewConfig, uiConfig: UIConfig) {
    self.config = config
...
// MARK: - Set up UI
private extension ManageCardTopMessageView {
  func setUpUI() {
